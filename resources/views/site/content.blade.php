...
{{--                                        <h2>We create <strong>awesome</strong> web templates</h2>--}}
                                ...
                                <div class="col-lg-7 col-sm-5">
                                   {!! Form::image('assets/img/'.$page->images) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="inner_wrapper">
                    <div class="container">
                        ...
                        <div class="inner_section">
                            <div class="row">
                                <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right">{!! Form::image('assets/img/'.$page->images,'',array('class'=>'img-circle delay-03s animated wow zoomIn')) !!} </div>
            ...
            @foreach($portfolios as $item)
                <!-- Portfolio Item -->
                    <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   {{ $item->filter }} isotope-item">
                        <div class="portfolio_img"> {{ Form::image('assets/img/'.$item->images,$item->name) }} </div>
                ...
                @foreach($peoples as $k=>$people)
                    <div class="team_area">
                        <div class="team_box wow fadeInDown delay-0{{ ($k*3 + 3) }}s">
                            ...
                            {{ Form::image('assets/img/'.$people->images,$people->name) }}
                            <ul>
